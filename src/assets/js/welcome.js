      ...
      o = function() {
        ...
        return n(e, [{
          ...
          value: function() {
            ...
            this.width = document.getElementsByClassName('content')[0].offsetWidth
            this.height = document.getElementsByClassName('content')[0].offsetHeight
            this.dpr = window.devicePixelRatio > 1 ? 2 : 1, this.camera.aspect = this.width / this.height, this.camera.updateProjectionMatrix(), this.renderer.setPixelRatio(this.dpr), this.renderer.setSize(this.width, this.height)
          }
        }, {
