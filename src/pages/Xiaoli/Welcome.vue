<template>
  <div class="demo-4" @class="render ? 'render' : ''">
  <main>
    <div class="content content--fixed" style="display: none">
...
// import 'src/assets/js/OrbitControls'
export default {
  name: 'Welcome',
  data () {
    return {
  ...
  mounted () {
    require('src/assets/js/OrbitControls')
    require('src/assets/js/welcome')
    this.render = true
  }
}
</script>
