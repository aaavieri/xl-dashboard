...
<script>
  ...
  import SidebarShare from 'src/pages/Dashboard/Layout/Extra/SidebarSharePlugin'
  ...
  import TopNavbar from 'src/pages/Dashboard/Layout/TopNavbar.vue'
  import ContentFooter from 'src/pages/Dashboard/Layout/ContentFooter.vue'
  import DashboardContent from 'src/pages/Dashboard/Layout/Content.vue'
  import MobileMenu from 'src/pages/Dashboard/Layout/Extra/MobileMenu.vue'
  import UserMenu from 'src/pages/Dashboard/Layout/Extra/UserMenu.vue'
